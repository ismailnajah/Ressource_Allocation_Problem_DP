all: bin/ bin/main.o bin/CSV_Parser.o bin/dyn_max_iterative.o bin/dyn_max_recurcive.o
	gcc -o "bin/main" "bin/main.o" "bin/CSV_Parser.o" "bin/dyn_max_iterative.o" "bin/dyn_max_recurcive.o" -Wall
